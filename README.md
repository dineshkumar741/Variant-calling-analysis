...
# Annotation
Annotation was performed using the SnpEff tool which helps to predict the variants effects on genes and proteins. Therefore, potentially significant variants are identified to explore further biological interpretation.
